    ...
    @endif
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
            <div class="flex items-center text-sm text-gray-600 font-medium space-x-2">
                ...
                <a href="{{ route('pengawas.dashboard') }}" wire:navigate class="hover:text-blue-600 transition">Monitor Ujian</a>
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
            ...
            <div class="mt-2 sm:mt-0 flex items-center space-x-3">
                ...
                <a href="{{ route('pengawas.exams.monitor.print', $exam->id) }}" target="_blank" class="bg-indigo-600 hover:bg-indigo-700 text-white focus:ring-4 focus:ring-indigo-400 font-medium py-1.5 px-4 rounded-full shadow-md transition transform hover:-translate-y-0.5 flex items-center border border-indigo-500 text-sm">
                ...
                <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full border border-gray-100">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 border-b border-gray-100 flex justify-between items-center sticky top-0 z-10">
                        ...
                        <div class="flex items-center space-x-2">
                            <!-- Note: Print session details logic is reused or hidden for Pengawas -->
