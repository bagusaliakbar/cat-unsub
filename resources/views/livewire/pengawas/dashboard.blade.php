            ...
            @forelse($exams as $exam)
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col transform transition duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div class="p-8 flex-grow">
                        ...
                        <a href="{{ route('pengawas.exams.monitor', $exam->id) }}" wire:navigate class="w-full flex justify-center items-center px-4 py-3 bg-gradient-to-r from-blue-700 to-blue-800 hover:from-blue-800 hover:to-blue-900 text-white rounded-xl transition shadow-md hover:shadow-lg font-bold">
